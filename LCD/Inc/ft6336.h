...
#define FT_RST_SET        HAL_GPIO_WritePin(GPIOG, GPIO_PIN_13, GPIO_PIN_SET)	//FT5206复位引脚
#define FT_RST_RESET        HAL_GPIO_WritePin(GPIOG, GPIO_PIN_13, GPIO_PIN_RESET)	//FT5206复位引脚
#define FT_INT    				HAL_GPIO_ReadPin(CTP_INT_GPIO_Port, CTP_INT_Pin)		//FT6636中断引脚	
